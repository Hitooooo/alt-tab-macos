...
enum ScreensToShowPreference: CaseIterable, MacroPreference {
    ...
    var localizedString: LocalizedString {
        switch self {
            ...
            case .showingAltTab: return NSLocalizedString("Screen showing CmdTab", comment: "")
        }
    }
}
...
enum AppearanceStylePreference: CaseIterable, ImageMacroPreference {
    ...
    case appIcons
    case titles
    static let visibleCases: [AppearanceStylePreference] = [.appIcons, .titles]

    var localizedString: LocalizedString {
        switch self {
            case .thumbnails, .appIcons: return NSLocalizedString("App Icons", comment: "")
    ...
    var image: WidthHeightImage {
        ...
        switch self {
            case .thumbnails, .appIcons: return WidthHeightImage(width: width, height: height, name: "app_icons")
